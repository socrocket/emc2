...
#ifndef MODELS_ARMGIC_ARMGIC_H_
#define MODELS_ARMGIC_ARMGIC_H_
...
class ArmGIC : public APBSlave, public CLKDevice {
  public:
    SC_HAS_PROCESS(ArmGIC);
    SR_HAS_SIGNALS(ArmGIC);
    GC_HAS_CALLBACKS();
    ...
    //tlm_utils::multi_passthrough_initiator_socket<ArmGIC, 32, tlm::tlm_base_protocol_types, 16, sc_core::SC_ZERO_OR_MORE_BOUND> irq_out_socket;
    amba::amba_master_socket<32, 0> irq_init_socket;
