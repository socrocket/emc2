...
core_armcortexa9_lt::TLMIntrPort_1::TLMIntrPort_1(
...
void core_armcortexa9_lt::TLMIntrPort_1::b_transport(
    int tag,
...
unsigned core_armcortexa9_lt::TLMIntrPort_1::transport_dbg(
    int tag,
    tlm::tlm_generic_payload& trans) {
  unsigned char* ptr = trans.get_data_ptr();
  sc_dt::uint64 adr = trans.get_address();
...
tlm::tlm_sync_enum core_armcortexa9_lt::TLMIntrPort_1::nb_transport_fw(
    int tag,
    tlm::tlm_generic_payload& trans,
    tlm::tlm_phase& phase,
    sc_time& delay) {
