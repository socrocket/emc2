...
core_armcortexa9_lt::Interface::~Interface() {
...
core_armcortexa9_lt::Interface::Interface(
    ...
    boost::circular_buffer<HistoryInstrType>& history_queue) :
...
bool core_armcortexa9_lt::Interface::is_little_endian() const throw() {
  return true;
} // is_little_endian()

/// ----------------------------------------------------------------------------

int core_armcortexa9_lt::Interface::get_id() const throw() {
  return (MP_ID);
} // get_id()

/// ----------------------------------------------------------------------------

bool core_armcortexa9_lt::Interface::is_executing_instr() const throw() {
  return this->instr_executing;
} // is_executing_instr()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::wait_instr_end() const throw() {
...
bool core_armcortexa9_lt::Interface::is_routine_entry(const InstructionBase*
instr) throw() {
...
bool core_armcortexa9_lt::Interface::is_routine_exit(const InstructionBase*
instr) throw() {
...
unsigned char* core_armcortexa9_lt::Interface::get_state() const throw() {
...
void core_armcortexa9_lt::Interface::set_state(unsigned char* state) throw() {
...
void core_armcortexa9_lt::Interface::set_exit_value(unsigned value) throw() {
  this->exit_value = value;
} // set_exit_value()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::get_exit_value() throw() {
  return this->exit_value;
} // get_exit_value()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::get_code_limit() {
  return this->PROGRAM_LIMIT;
} // get_code_limit()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::read_LR() const throw() {
  return LR;
} // read_LR()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::set_LR(const unsigned& new_value) throw() {
  LR.write_force(new_value);
} // set_LR()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::read_PC() const throw() {
  return PC + 4;
} // read_PC()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::set_PC(const unsigned& new_value) throw() {
  PC.write_force(new_value);
} // set_PC()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::read_SP() const throw() {
  return SP;
} // read_SP()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::set_SP(const unsigned& new_value) throw() {
  SP.write_force(new_value);
} // set_SP()

/// ----------------------------------------------------------------------------

unsigned core_armcortexa9_lt::Interface::read_return_value() const throw() {
  return REGS[0];
} // read_return_value()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::set_return_value(const unsigned& new_value)
throw() {
...
std::vector<unsigned> core_armcortexa9_lt::Interface::read_args() const throw()
{
...
void core_armcortexa9_lt::Interface::set_args(const std::vector<unsigned>& args)
throw() {
  if (args.size() > 4) {
    THROW_EXCEPTION("Too many arguments for processor ABI, given " << args.size()
    << ", expected up to 4 .");
  }
  std::vector<unsigned >::const_iterator arg_it = args.begin(), arg_end =
  args.end();
  if (arg_it != arg_end) {
...
unsigned core_armcortexa9_lt::Interface::read_gdb_reg(const unsigned& gdb_id)
const throw() {
  switch(gdb_id) {
    case 0: {
      return REGS[0];
...
unsigned core_armcortexa9_lt::Interface::num_gdb_regs() const throw() {
  return 17;
} // num_gdb_regs()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::Interface::set_gdb_reg(
...
unsigned core_armcortexa9_lt::Interface::read_mem(const unsigned& address) {
  return this->data_memory.read_word_dbg(address);
} // read_mem()

/// ----------------------------------------------------------------------------

unsigned char core_armcortexa9_lt::Interface::read_char_mem(const unsigned&
address) {
...
void core_armcortexa9_lt::Interface::write_mem(
...
void core_armcortexa9_lt::Interface::write_char_mem(
    const unsigned& address,
    unsigned char datum) {
...
boost::circular_buffer<HistoryInstrType>& core_armcortexa9_lt::Interface::get_history()
{
