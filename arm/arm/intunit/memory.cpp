...
core_armcortexa9_lt::MemoryInterface::~MemoryInterface() {

} // ~MemoryInterface()

/// ----------------------------------------------------------------------------

sc_dt::uint64 core_armcortexa9_lt::MemoryInterface::read_dword_dbg(const unsigned&
address) const {
...
unsigned core_armcortexa9_lt::MemoryInterface::read_word_dbg(const unsigned&
address) const {
...
unsigned short int core_armcortexa9_lt::MemoryInterface::read_half_dbg(const
...
unsigned char core_armcortexa9_lt::MemoryInterface::read_byte_dbg(const unsigned&
address) const {
...
void core_armcortexa9_lt::MemoryInterface::write_dword_dbg(
...
void core_armcortexa9_lt::MemoryInterface::write_word_dbg(
    const unsigned& address,
    unsigned datum) {
...
void core_armcortexa9_lt::MemoryInterface::write_half_dbg(
    const unsigned& address,
...
void core_armcortexa9_lt::MemoryInterface::write_byte_dbg(
    const unsigned& address,
    unsigned char datum) {
...
core_armcortexa9_lt::LocalMemory::LocalMemory(unsigned size) :
  size(size) {
...
core_armcortexa9_lt::LocalMemory::~LocalMemory() {
  delete [] this->memory;
} // ~LocalMemory()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::LocalMemory::set_debugger(MemoryToolsIf<unsigned>*
debugger) {
...
sc_dt::uint64 core_armcortexa9_lt::LocalMemory::read_dword(const unsigned&
address) const throw() {
...
unsigned short int core_armcortexa9_lt::LocalMemory::read_half(const unsigned&
address) const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
unsigned char core_armcortexa9_lt::LocalMemory::read_byte(const unsigned&
address) const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
sc_dt::uint64 core_armcortexa9_lt::LocalMemory::read_dword_dbg(const unsigned&
address) const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
unsigned core_armcortexa9_lt::LocalMemory::read_word_dbg(const unsigned& address)
const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
unsigned short int core_armcortexa9_lt::LocalMemory::read_half_dbg(const unsigned&
address) const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
unsigned char core_armcortexa9_lt::LocalMemory::read_byte_dbg(const unsigned&
address) const throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
  }
...
void core_armcortexa9_lt::LocalMemory::write_dword(
    const unsigned& address,
...
void core_armcortexa9_lt::LocalMemory::write_half(
    const unsigned& address,
...
void core_armcortexa9_lt::LocalMemory::write_byte(
    const unsigned& address,
...
void core_armcortexa9_lt::LocalMemory::write_dword_dbg(
    const unsigned& address,
    sc_dt::uint64 datum) throw() {
  if (address >= this->size) {
    THROW_ERROR("Address " << std::hex << std::showbase << address << " out of memory.");
...
void core_armcortexa9_lt::LocalMemory::write_word_dbg(
    const unsigned& address,
...
void core_armcortexa9_lt::LocalMemory::write_half_dbg(
    const unsigned& address,
    unsigned short int datum) throw() {
#ifdef BIG_ENDIAN_BO
#else
...
void core_armcortexa9_lt::LocalMemory::write_byte_dbg(
    const unsigned& address,
    unsigned char datum) throw() {
#ifdef BIG_ENDIAN_BO
#else
...
void core_armcortexa9_lt::LocalMemory::lock() {

} // lock()

/// ----------------------------------------------------------------------------

void core_armcortexa9_lt::LocalMemory::unlock() {
